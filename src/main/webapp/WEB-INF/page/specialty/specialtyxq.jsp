...
<body>
	...
	<div class="b_wrap">
		<div class="current">
			<span>当前所在地：</span><a href="SpecialtyList">首页</a> >> <a
				href="SpecialtyList">地方特产</a>>> <a href="#">商品详情</a>
		</div>
							...
							<form action="${path }/Specialty/getFilmData"
								...
								<div class="cln_w">
									...
									<div class="cln_c clearfix">
										<a href="#" onclick="query(0)">钟楼特产</a> <a href="#"
											onclick="query(1)">武进特产</a> <a href="#" onclick="query(2)">新北特产</a>
										<a href="#" onclick="query(3)">溧阳特产</a> <a href="#"
											onclick="query(4)">金坛特产</a> <a href="#" onclick="query(5)">天宁特产</a>
									</div>
								</div>
								<div class="cln_w">
									<p>徐州市</p>
									<div class="cln_c clearfix">
										<a href="#" onclick="query(6)">泉山特产</a> <a href="#"
											onclick="query(7)">丰县特产</a> <a href="#" onclick="query(8)">沛县特产</a>
										<a href="#" onclick="query(9)">铜山特产</a> <a href="#"
								...
								<div class="cln_w">
									...
									<div class="cln_c clearfix">
										...
										<a onclick="query(11)">玄武特产</a> <a href="#"
											onclick="query(12)">栖霞特产</a> <a href="#" onclick="query(13)">雨花台特产</a>
										<a href="#" onclick="query(14)">江宁特产</a>
									</div>
								</div>
								<div class="cln_w">
									<p>连云港</p>
									<div class="cln_c clearfix">
										<a href="#" onclick="query(15)">灌云特产</a> <a href="#"
											onclick="query(16)">灌南特产</a> <a href="#" onclick="query(17)">连云特产</a>
										<a href="#" onclick="query(18)">海州特产</a> <a href="#"
								...
								<div class="cln_w">
									<p>南通市</p>
									<div class="cln_c clearfix">
										<a href="#" onclick="query(20)">崇川特产</a> <a href="#"
											onclick="query(21)">海安特产</a> <a href="#" onclick="query(22)">如东特产</a>
										<a href="#" onclick="query(23)">启东特产</a> <a href="#"
								...
								<div class="cln_w">
									<p>无锡市</p>
									<div class="cln_c clearfix">
										<a href="#" onclick="query(25)">江阴特产</a> <a href="#"
											onclick="query(26)">宜兴特产</a> <a href="#" onclick="query(27)">锡山特产</a>
										<a href="#" onclick="query(28)">惠山特产</a> <a href="#"
								...
								<div class="cln_w">
									<p>扬州市</p>
									<div class="cln_c clearfix">
										<a href="#" onclick="query(30)">宝应特产</a> <a href="#"
											onclick="query(31)">仪征特产</a> <a href="#" onclick="query(32)">高邮特产</a>
										<a href="#" onclick="query(33)">广陵特产</a> <a href="#"
								...
								<div class="cln_w">
									<p>苏州市</p>
									<div class="cln_c clearfix">
										<a href="#" onclick="query(35)">太仓特产</a> <a href="#"
											onclick="query(36)">昆山特产</a> <a href="#" onclick="query(37)">吴江特产</a>
										<a href="#" onclick="query(38)">姑苏特产</a> <a href="#"
											onclick="query(39)">虎丘特产</a> <a href="#" onclick="query(40)">吴中特产</a>
										<a href="#" onclick="query(41)">相城特产</a>
									</div>
								</div>
							</form>
						</div>
