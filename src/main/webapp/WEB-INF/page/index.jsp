    ...
    <div class="clumn_w sy_c01 clearfix">
        ...
        <div class="jx_wrap clearfix">
            ...
            <div class="zb_con clearfix">
              <ul class="zb_ul">
              <li><a href="${path }/route/routeList">游浙东大峡谷，赏小三峡风光，玩白溪漂流，住豪华宁海开元新世纪大酒店，享惬意旅途</a><span>¥710起</span></li>
              <li><a href="${path }/route/routeList">【象山海滨游】踏浪、玩沙、游古城，住象山海洋酒店                              </a><span>¥558起</span></li>
              <li><a href="${path }/route/routeList">【暑期特惠】双人两日游宁波九龙湖，亲近自然山水风光，住挂牌五星远洲大酒店      </a><span>¥478起</span></li>
              <li><a href="${path }/route/routeList">【溪口二日游】感受人文之精华，山水之灵秀，佛教之庄严                          </a><span>¥768起</span></li>
              <li><a href="${path }/route/routeList">【凤凰山海港乐园】浪漫、刺激、梦幻，爱她就带她去双人二日游                    </a><span>¥810起</span></li>
              <li><a href="${path }/route/routeList">【暑期特惠，杭州浪漫2日自由行】★游西溪湿地非诚勿扰拍摄地，赏西溪浪漫美景！   </a><span>¥410起</span></li>
              <li><a href="${path }/route/routeList">杭州临安双人2日游，体验激情漂流，感受峡谷风景，完美旅行，超值特惠！           </a><span>¥510起</span></li>
            </ul>
            </div>
          </div>
    </div>
        ...
        <div class="clumn_cl">
          ...
          <div class="df_wrap">
            ...
            <c:forEach items="${page2.datas }" var="spe">
              <dl>
                <dt><a href="${path}/specialty/specialtyDetail?id=${spe.id}"><img src="${path }/images/${spe.images}" style="width: 160px;height: 124px"></a></dt>
                <dd>
                  <p class="d01"><a href="${path}/specialty/specialtyDetail?id=${spe.id}">【${spe.numberNo }特产】${spe.speName }</a></p>
            ...
            <div class="clumn">
                ...
                <div class="clumn_con">
                    <ul class="clu_ul page_ul">
                        <li><a href="${path }/sights/all">六日黄石公园, 现有女一人，寻女性同游</a></li>
                        <li><a href="${path }/sights/all">国庆长假，温哥华维多利亚自助游找伴</a></li>
                        <li><a href="${path }/sights/all">去NewFundland，自助游！ 肯定走！</a></li>
                        <li><a href="${path }/sights/all">多伦多-温哥华 横跨之旅</a></li>
                        <li><a href="${path }/sights/all">诚招一女， 已有7人定下去NewFoundland</a></li>
                        <li><a href="${path }/sights/all">六日黄石公园, 现有女一人，寻女性同游</a></li>
                        <li><a href="${path }/sights/all">暑期邮轮 特价不断</a></li>
                        <li><a href="${path }/sights/all">订机票，选银联，超值特惠</a></li>
                        <li><a href="${path }/sights/all">诚招一女， 已有7人定下去NewFoundland</a></li>
                        <li><a href="${path }/sights/all">六日黄石公园, 现有女一人，寻女性同游</a></li>
                        <li><a href="${path }/sights/all">暑期邮轮 特价不断</a></li>
                        <li><a href="${path }/sights/all">订机票，选银联，超值特惠</a></li>
